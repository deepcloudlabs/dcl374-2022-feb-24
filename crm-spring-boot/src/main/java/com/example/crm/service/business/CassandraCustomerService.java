...
import com.example.crm.repository.CustomerCassandraRepository;
import com.example.crm.service.CustomerService;

@Service
@ConditionalOnProperty(
		name = "database", havingValue = "cassandra"
)
public class CassandraCustomerService implements CustomerService {
	...
	private CustomerCassandraRepository customerRepository;
	private ModelMapper modelMapper;

	public CassandraCustomerService(CustomerCassandraRepository customerRepository, ModelMapper modelMapper) {
	...
	public AddCustomerResponse createCustomer(AddCustomerRequest request) {
		var customer = modelMapper.map(request, CustomerModel.class);
